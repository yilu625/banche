	...
	<body>
		...
		<div id="show-user" class="content scaffold-show" role="main">
			...
			<ol class="property-list user">
				...
				<g:if test="${userInstance?.userPwd}">
				<li class="fieldcontain">
					<span id="userPwd-label" class="property-label"><g:message code="user.userPwd.label" default="User Pwd" /></span>
					
						<span class="property-value" aria-labelledby="userPwd-label"><g:fieldValue bean="${userInstance}" field="userPwd"/></span>
